...
cv2.createTrackbar("upper_hue", "bars", 30, 180, hello)
cv2.createTrackbar("upper_saturation", "bars", 255, 255, hello)
cv2.createTrackbar("upper_value", "bars", 255, 255, hello)
cv2.createTrackbar("lower_hue", "bars", 14, 180, hello)
cv2.createTrackbar("lower_saturation", "bars", 100, 255, hello)
cv2.createTrackbar("lower_value", "bars", 101, 255, hello)
...
while (True):
    ...
    cv2.imshow("KK Transparent", final)
